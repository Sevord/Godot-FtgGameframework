...
#动作融合的百分比时间
var TransitionNormalized:float
...
var FreezingAfterChangeAction:float

func _init(ActionId:String,Priority:int = 0,TransitionNormalized:float =0 ,FromNormalized:float=0,FreezingAfterChangeAction:float =0):
	self.ActionId = ActionId
	self.Priority = Priority
	self.TransitionNormalized = TransitionNormalized
	self.FromNormalized = FromNormalized
	self.FreezingAfterChangeAction = FreezingAfterChangeAction
